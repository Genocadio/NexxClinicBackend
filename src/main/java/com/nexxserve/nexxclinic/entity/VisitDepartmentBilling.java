...
@Entity
@Table(name = "visit_department_billings")
public class VisitDepartmentBilling {
    ...
    public List<DepartmentInsuranceBilling> getInsuranceBillings() {
        return insuranceBillings;
    }
