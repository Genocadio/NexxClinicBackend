...
# Wipes the local database and populates demo data for testing.
# Invoke manually: ./seed-local.sh
# ============================================================================
set -euo pipefail
...
DB_PASS="${DB_PASSWORD:-nexxclinic_pass}"
...
cd "$(dirname "$0")"
./gradlew flywayMigrate -Dspring.flyway.url="jdbc:postgresql://$DB_HOST:$DB_PORT/$DB_NAME" \
  -Dspring.flyway.user="$DB_USER" -Dspring.flyway.password="$DB_PASS" \
...
# Users
USER_ADMIN='c0000001-0000-0000-0000-000000000001'
USER_MULTI='c0000002-0000-0000-0000-000000000002'

# Patients
PAT_1='d0000001-0000-0000-0000-000000000001'
PAT_2='d0000002-0000-0000-0000-000000000002'
PAT_3='d0000003-0000-0000-0000-000000000003'

# Coverage IDs
COV_BASE_RSSB='e0000001-0000-0000-0000-000000000001'
COV_DENTAL_RSSB='e0000002-0000-0000-0000-000000000002'
COV_BASE_MMI='e0000003-0000-0000-0000-000000000003'
COV_BASE_OLDMUTUAL='e0000004-0000-0000-0000-000000000004'
COV_DENTAL_OLDMUTUAL='e0000005-0000-0000-0000-000000000005'
COV_NURSE_OLDMUTUAL='e0000006-0000-0000-0000-000000000006'
COV_INTERNAL_OLDMUTUAL='e0000007-0000-0000-0000-000000000007'
COV_BASE_RADIANT='e0000008-0000-0000-0000-000000000008'
COV_DENTAL_RADIANT='e0000009-0000-0000-0000-000000000009'
COV_NURSE_RADIANT='e000000a-0000-0000-0000-00000000000a'
COV_INPATIENT_RADIANT='e000000b-0000-0000-0000-00000000000b'
...
-- RSSB: base only (20% patient share → insurance covers 80%)
...
-- MMI: base only (15% patient share → insurance covers 85%)
INSERT INTO insurance_coverage (id, insurance_provider_id, department_id, encounter_type, patient_share_percentage, created_at, updated_at) VALUES
...
-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║  PRODUCTS  (20 total: mix of drugs, medical acts, consumables)           ║
-- ╚══════════════════════════════════════════════════════════════════════════╝
...
-- Drugs (8)
('10000001-0000-0000-0000-000000000001', 'DRUG', 'DRG-001', 'TABLET',   'Amoxicillin 500mg',    'Amoxicillin',    'Antibiotic capsule',            2500.00,  3000.00, now(), now(), '{}'),
('10000002-0000-0000-0000-000000000002', 'DRUG', 'DRG-002', 'TABLET',   'Paracetamol 500mg',    'Paracetamol',    'Pain relief tablet',             800.00,  1000.00, now(), now(), '{}'),
('10000003-0000-0000-0000-000000000003', 'DRUG', 'DRG-003', 'CAPSULE',  'Omeprazole 20mg',      'Omeprazole',     'Proton pump inhibitor',         3500.00,  4000.00, now(), now(), '{}'),
('10000004-0000-0000-0000-000000000004', 'DRUG', 'DRG-004', 'TABLET',   'Metformin 500mg',      'Metformin',      'Antidiabetic tablet',           1200.00,  1500.00, now(), now(), '{}'),
('10000005-0000-0000-0000-000000000005', 'DRUG', 'DRG-005', 'VIAL',     'Insulin Regular',      'Insulin',        'Injectable insulin',            15000.00, 18000.00, now(), now(), '{}'),
('10000006-0000-0000-0000-000000000006', 'DRUG', 'DRG-006', 'AMPOULE',  'Diclofenac 75mg',      'Diclofenac',     'NSAID injection',               1500.00,  2000.00, now(), now(), '{}'),
('10000007-0000-0000-0000-000000000007', 'DRUG', 'DRG-007', 'TABLET',   'Ciprofloxacin 500mg',  'Ciprofloxacin',  'Fluoroquinolone antibiotic',    2000.00,  2500.00, now(), now(), '{}'),
('10000008-0000-0000-0000-000000000008', 'DRUG', 'DRG-008', 'TUBE',     'Hydrocortisone Cream', 'Hydrocortisone', 'Topical steroid cream',         1800.00,  2200.00, now(), now(), '{}'),
-- Medical Acts (8)
('10000009-0000-0000-0000-000000000009', 'MEDICAL_ACT', 'ACT-001', 'DOSE',     'Dental Consultation',     NULL, 'General dental checkup',       10000.00, 12000.00, now(), now(), '{}'),
('1000000a-0000-0000-0000-00000000000a', 'MEDICAL_ACT', 'ACT-002', 'DOSE',     'Tooth Extraction',        NULL, 'Simple tooth extraction',      15000.00, 18000.00, now(), now(), '{}'),
('1000000b-0000-0000-0000-00000000000b', 'MEDICAL_ACT', 'ACT-003', 'DOSE',     'Dental X-Ray',            NULL, 'Periapical radiograph',        8000.00,  10000.00, now(), now(), '{}'),
('1000000c-0000-0000-0000-00000000000c', 'MEDICAL_ACT', 'ACT-004', 'DOSE',     'Blood Test - CBC',        NULL, 'Complete blood count',         5000.00,  6000.00, now(), now(), '{}'),
('1000000d-0000-0000-0000-00000000000d', 'MEDICAL_ACT', 'ACT-005', 'DOSE',     'Blood Test - Glucose',    NULL, 'Fasting blood glucose',        3000.00,  4000.00, now(), now(), '{}'),
('1000000e-0000-0000-0000-00000000000e', 'MEDICAL_ACT', 'ACT-006', 'DOSE',     'ECG',                     NULL, 'Electrocardiogram',           12000.00, 15000.00, now(), now(), '{}'),
('1000000f-0000-0000-0000-00000000000f', 'MEDICAL_ACT', 'ACT-007', 'DOSE',     'General Consultation',    NULL, 'Doctor consultation',          10000.00, 12000.00, now(), now(), '{}'),
('10000010-0000-0000-0000-000000000010', 'MEDICAL_ACT', 'ACT-008', 'DOSE',     'Wound Dressing',          NULL, 'Wound care and dressing',      3000.00,  4000.00, now(), now(), '{}'),
-- Consumable Devices (4)
('10000011-0000-0000-0000-000000000011', 'CONSUMABLE_DEVICE', 'CSM-001', 'PIECE', 'Syringe 5ml',        NULL, 'Disposable syringe',           500.00,   700.00, now(), now(), '{}'),
('10000012-0000-0000-0000-000000000012', 'CONSUMABLE_DEVICE', 'CSM-002', 'PIECE', 'Gloves (pair)',      NULL, 'Disposable latex gloves',      300.00,   400.00, now(), now(), '{}'),
('10000013-0000-0000-0000-000000000013', 'CONSUMABLE_DEVICE', 'CSM-003', 'PIECE', 'IV Cannula 20G',     NULL, 'Intravenous cannula',          1200.00,  1500.00, now(), now(), '{}'),
('10000014-0000-0000-0000-000000000014', 'CONSUMABLE_DEVICE', 'CSM-004', 'PIECE', 'Surgical Mask',      NULL, 'Disposable face mask',         200.00,   300.00, now(), now(), '{}');

-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║  PRODUCT INSURANCE COVERAGE (which products each insurance covers)       ║
-- ╚══════════════════════════════════════════════════════════════════════════╝

-- RSSB covers most products
...
-- Insulin NOT covered by RSSB (not_paid = true)
...
ON CONFLICT (department_id, insurance_provider_id) DO NOTHING;
